...
// omp_orphan.c
// - This program demonstrates an orphaned directive, 
//   where the parallel directive is outside the function performing the work. 
// - The reduction variable scope is crucial.
